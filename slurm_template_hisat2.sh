...
hisat2 --threads 8 \
	-x /project/hert7274/SHARED/linux/5_rnaseq/hisat2_index/mm10 \
	-1 /project/hert7274/1_linux/2_rnaseq/1_fastq/cd4_rep1_read1.fastq.gz \
	-2 /project/hert7274/1_linux/2_rnaseq/1_fastq/cd4_rep1_read2.fastq.gz \
	--rna-strandness RF \
